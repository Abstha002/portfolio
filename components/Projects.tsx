    ...
    >
      <div className="mx-auto max-w-4xl px-6">
            ...
            >
              {project.placeholder ? (
                ...
                <div className="flex flex-1 flex-col items-center justify-center py-8 text-center">
                  <div className="mb-3 flex h-10 w-10 items-center justify-center rounded-xl border border-dashed border-stone-300 text-stone-300">
                    <svg
                      width="20"
                      height="20"
                      viewBox="0 0 20 20"
                ...
                <>
                    ...
                    <div className="flex gap-2">
                      {project.github && (
                        <a
                          ...
                          rel="noopener noreferrer"
                          aria-label="GitHub"
                          className="text-stone-300 transition-colors hover:text-stone-700"
                        >
                          <svg
                            width="16"
                            height="16"
                  ...
                  <h3 className="mb-1.5 text-sm font-medium text-stone-900">
                    {project.name}
                  </h3>
                  <p className="mb-4 flex-1 text-xs leading-relaxed text-stone-500">
                    {project.description}
                  </p>
                  ...
                  <div className="flex flex-wrap gap-1.5">
                    {project.stack.map((tech) => (
                      <span
                        key={tech}
                        className="rounded-md border border-stone-100 bg-stone-50 px-2 py-0.5 font-mono text-[10px] text-stone-500"
                      >
                        {tech}
                      </span>
                    ))}
        ...
        <div className="mt-8 text-center">
          <Link
            href="/project"
            className="inline-flex items-center gap-2 font-mono text-xs text-stone-400 transition-colors hover:text-stone-700"
          >
