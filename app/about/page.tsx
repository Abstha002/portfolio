...
export default function About() {
  return (
    ...
    <div>
      ...
      <p className="text-black text-center p-5">I’m Abhay Raj Shrestha, a BSc.CSIT student at Himalaya College of Engineering, driven by a deep passion for building digital solutions. I specialize in front-end development using React and Next.js, and I’m also proficient in Python, with working knowledge of several languages including Java, C++, and C#.
